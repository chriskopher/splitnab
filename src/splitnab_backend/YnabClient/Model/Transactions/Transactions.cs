...
namespace YnabClient.Model.Transactions
{
    ...
    public class SaveTransaction
    {
        ...
        /// <summary>
        ///     The transaction amount in milliunits format. Split transaction amounts cannot be changed and if a different amount
        ...
        /// <summary>
        ///     The payee name. If a payee_name value is provided and payee_id has a null value, the payee_name value will be used
        ///     to resolve the payee by either (1) a matching payee rename rule (only if import_id is also specified) or (2) a
        ///     payee with the same name or (3) creation of a new payee.
        ///     Max Length: 50
        /// </summary>
        ...
        ///     to match this imported transaction to an existing “user-entered” transaction on the same account, with the same
        ...
        ///     If import_id is omitted or specified as null, the transaction will be treated as a “user-entered” transaction. As
    ...
    public class SaveSubTransaction
    {
        ...
        ///     maxLength: 50
        ///     The payee name. If a payee_name value is provided and payee_id has a null value, the payee_name value will be used
        ///     to resolve the payee by either (1) a matching payee rename rule (only if import_id is also specified on parent
